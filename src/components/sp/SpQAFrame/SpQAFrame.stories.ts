...
import { SpQAFrame } from "./SpQAFrame";
...
} as Meta<typeof SpQAFrame>;

export const Basic: StoryObj<typeof SpQAFrame> = {
  args: {
    mainColor: "#4A90E2",
    qaList: [
      {
...
export const DifferentColor: StoryObj<typeof SpQAFrame> = {
  args: {
    mainColor: "#E94E77",
    qaList: [
      {
